...
COLOR_TABULATE_BORDER = fore.LIGHT_GOLDENROD_2C
STYLE_TABULATE_BORDER = COLOR_TABULATE_BORDER

STYLE_RESET = style.RESET + STYLE_TABULATE_BORDER
...
STYLIZE_TABULATE_BORDER = lambda string: STYLE_TABULATE_BORDER + string + STYLE_RESET
